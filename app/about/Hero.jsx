...
export default function Hero(){
    return(
        <>
            <div className="text-5xl font-[700] my-10 text-center">About our company</div>
            <div className="text-lg font-[400] text-gray-500 text-center lg:w-[60vw] w-[90vw]">Founded with a passion for innovation and excellence, MythoQuantum Explorers pioneers the field of data science and research. We are committed to fusing cutting-edge technology with in-depth research to create transformative solutions across industries</div>
            <ContactUsButton />
        </>
    )
}